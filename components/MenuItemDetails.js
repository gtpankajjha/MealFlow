...
//   const filteredItems = saladDetails?.filter((salad) => {
//     if (
...
//             <div
//               style={{
//                 border: "1px solid rgb(128, 181, 59)",
//                 borderRadius: "5px",
//                 padding: "5%",
//               }}
//             >
//               <h2 style={{ color: "#000", textAlign: "center" }}>
//                 No Item Found For <span style={{ color: "red" }}>Non-Veg</span>{" "}
//                 In This Section
//               </h2>
//             </div>
//           ) : (
...
//                     {salad.menuTitle}
//                   </label>
//                   <p className={styles.menuDesp}>{salad.menuDesp}</p>
//                   {salad.macros.map((macro, index) => (
